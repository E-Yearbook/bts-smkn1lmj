                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Enter your name and nis to sign in!
                            </p>
                        </div>
                        <div>
<form method="POST" action="{{ route('login-post') }}">
                            ...
                            <div>
                                ...
                                <div x-data="{ showPassword: false }" class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" name="password"
                                        placeholder="Masukkan Password atau NIS" required
                                        class="w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm dark:border-gray-700 dark:text-white" />
                                    </div>
                            </div>

                            <button type="submit"
                                class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 hover:bg-brand-600">
                                Sign In
                            </button>
                        </div>
                    </form>
    ...
    <script>
        Swal.fire({
            ...
            title: 'Oops...',
            text: "{{ session('error') }}",
            confirmButtonColor: '#4F46E5', // Warna brand
        });
    </script>
    @endif
</body>
