...
@section('content')
    ...
    <section class="relative min-h-screen flex items-center bg-[#fafaf9] overflow-hidden font-serif">
        ...
        <div class="relative z-10 w-full py-[72px]">
            ...
            <div class="pt-6 pb-14" data-aos="fade-up" data-aos-duration="700" data-aos-delay="120">
                ...
                @if ($count === 0)
                    <div class="flex flex-col items-center justify-center py-20 gap-5">
                        <div
                            class="w-[80px] h-[80px] rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center">
                            <svg class="w-9 h-9 text-indigo-300" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <div class="text-center">
                            <p class="text-[1.1rem] font-bold italic text-[#1a1a1a] tracking-tight mb-1">
                                Belum ada buku angkatan
                            </p>
                            <p class="font-mono text-[11px] text-[#a3a3a3] tracking-[0.06em]">
                                Admin belum menambahkan data tahun angkatan
                            </p>
                        </div>
                    </div>
                @else
                                    ...
                                    @foreach ($slideItems as $year)
                                        ...
                                        group-hover:border-indigo-400/25">
                                                 ...
                                                 group-hover:opacity-100 group-hover:translate-y-0">
                                                            Buka
                                                            <svg class="w-[11px] h-[11px]" viewBox="0 0 24 24"
            ...
            {{-- ── Footer deco ── --}}
            <footer class="flex items-center justify-center gap-5 mt-[52px] max-w-4xl mx-auto px-8" data-aos="fade-up"
