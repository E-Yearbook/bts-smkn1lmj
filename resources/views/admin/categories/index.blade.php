...
@section('content')
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-800">
            ...
            <span class="rounded-full bg-brand-50 px-3 py-1 text-xs font-semibold text-brand-500 dark:bg-brand-950 dark:text-brand-300">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            @foreach ($categories as $index => $category)
                                <tr
                                    class="border-b border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-white/5">
